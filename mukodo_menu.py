...
cap.set(3, 980)# camera nagysága (framrate,width)
cap.set(4, 720)# camera nagysága 2 (framrate,high)
...
def jatek(ball):
    ...
    #------------------------------------------------------------------------------------------
        ...
        if results.multi_hand_landmarks:
            for handLms in results.multi_hand_landmarks: # játékos 1
                for id, lm in enumerate(handLms.landmark):
                    ...
                    if 490 < cx < 1000:
                        ...
                        if cy < 721:
                            cy = 720
        if results.multi_hand_landmarks: # játékos 2
